...
// shutdown is a type used to help with the graceful termination fo the service
...
// IsShutdown check to see if the shutdown error is contained is in specified error value.
